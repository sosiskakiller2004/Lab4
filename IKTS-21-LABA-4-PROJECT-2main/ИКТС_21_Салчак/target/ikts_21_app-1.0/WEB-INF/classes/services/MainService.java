...
public class MainService {
    ...
    public void editWarehouse(int ProductID, String ProductName, int Quantity, double Price, String Supplier, String DateReceived) {
        String sql = "UPDATE warehouse SET ProductName =?, Quantity =?, Price =?, Supplier =?, DateReceived =? WHERE ProductID =?";
        dbService.update(sql, ProductName, Quantity, Price, Supplier, DateReceived, ProductID);
    }
    ...
    public List<Map<String,Object>> getNames() throws SQLException {
        ...
        while (rs.next()){
            ...
            row.put("DateReceived", rs.getTimestamp("DateReceived"));
